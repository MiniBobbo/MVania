...
class TmxTools
{
	...
	function CreateTilemapFromIntArray(intArray:Array<Int>, layer:Fast, layername:String):Void
	{
		...
		_tilemap.loadMapFromArray(intArray, Std.parseInt(layer.att.width), Std.parseInt(layer.att.height), _imageLocation + tileSet.name, tileSet.tileWidth, tileSet.tileHeight,null, 0,1,1);
