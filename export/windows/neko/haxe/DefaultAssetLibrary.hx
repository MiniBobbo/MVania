...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/data/levels/CombinedTiles.png", AssetType.IMAGE);
		path.set ("assets/data/temple2.tmx", "assets/data/temple2.tmx");
		type.set ("assets/data/temple2.tmx", AssetType.TEXT);
		path.set ("assets/data/templemgsheet.png", "assets/data/templemgsheet.png");
		type.set ("assets/data/templemgsheet.png", AssetType.IMAGE);
		...
		type.set ("assets/images/fire_0.png", AssetType.IMAGE);
		path.set ("assets/images/images-go-here.txt", "assets/images/images-go-here.txt");
		type.set ("assets/images/images-go-here.txt", AssetType.TEXT);
		path.set ("assets/images/main.json", "assets/images/main.json");
		type.set ("assets/images/main.json", AssetType.TEXT);
		...
		id = "assets/data/levels/CombinedTiles.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/data/temple2.tmx";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/templemgsheet.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/checkpoint.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/fire_0.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/images-go-here.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/main.json";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
