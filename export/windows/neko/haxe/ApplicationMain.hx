...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "MVania", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "MVania";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "MVania", null, { width: 480, height: 270 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 480, height: 270 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 480, 270, "null");
		#end
		#else
		create ();
		#end
